        ...
        <div class="container px-4">
          ...
          <div class="d-flex justify-content-end">
            <div class="text-nowrap ms-2">
              <a class="btn btn-outline-primary" href="${root}/hotplacearticle?pgno=1&key=&word=">
            ...
            <c:if test="${not empty userinfo}">
	            <c:if test="${userinfo.id eq article.userId}">
	                  ...
	                  <form id="form-no-param" method="get" action="${root}/hotplacearticle">
	                  ...
	                  <script>
	                    ...
	                    document.querySelector("#btn-delete").addEventListener("click", function () {
	                        if(confirm("정말 삭제하시겠습니까?")) {
	                            let form = document.querySelector("#form-no-param");
	                                form.setAttribute("action", "${root}/hotplacearticle/delete");
	                              form.submit();
	                        }
	                    });
	                  </script>
