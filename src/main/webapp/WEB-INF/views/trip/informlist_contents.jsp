        ...
        <div class="container px-4">
          ...
          <div class="d-flex justify-content-end">
            <div class="text-nowrap ms-2">
              <a class="btn btn-outline-primary" href="${root}/informarticle?pgno=1&key=&word=">
            ...
            <div class="text-nowrap ms-2">
              <a class="btn btn-outline-danger btn-delete" href="${root}/informarticle/delete?articleno=${article.articleNo}">
                <!-- <i class="fas fa-table me-1"></i> -->
