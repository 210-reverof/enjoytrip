...
//		ret.put("word", map.get("word"));
	...
	public Map<String, Object> informBoardWrite(@RequestParam Map<String, Object> map) throws Exception {
...
//		ret.put("word", map.get("word"));
	...
	public Map<String, Object> informBoardModify(@RequestParam Map<String, Object> map) throws Exception {
		InformArticleDto informArticleDto = (InformArticleDto) map.get("informArticleDto");
