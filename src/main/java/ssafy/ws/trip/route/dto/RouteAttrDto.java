...
public class RouteAttrDto {
	...
	public RouteAttrDto(boolean visited, int number, int contentId, int contentTypeId, String overview, String title,
	...
	public String toString() {
		return "RouteAttrDto [visited=" + visited + ", number=" + number + ", contentId=" + contentId + ", title="
