...
<html>
  ...
  <body>
        ...
        <div class="container px-4">
          ...
          <div class="d-flex justify-content-end">
            <div class="text-nowrap ms-2">
              <a class="btn btn-outline-primary" href="<%= root %>/informarticle?action=list">
                <!-- <i class="fas fa-table me-1"></i> -->
                <i class="fas fa-edit"></i> 글목록
              </a>
            </div>
            <div class="text-nowrap ms-2">
              <a class="btn btn-outline-success btn-mv-modify" href = "<%= root %>/informarticle?action=mvmodify&articleno=${article.articleNo}">
                <!-- <i class="fas fa-table me-1"></i> -->
                <i class="fas fa-edit"></i>  글수정
              </a>
            </div>
            <div class="text-nowrap ms-2">
              <a class="btn btn-outline-danger btn-delete" href="<%= root %>/informarticle?action=delete&articleno=${article.articleNo}">
                <!-- <i class="fas fa-table me-1"></i> -->
    ...
    document.querySelector("#btn-mv-modify").addEventListener("click", function () {
        alert("글수정하자!!!");
        location.href = "${root}/informarticle?action=mvmodify&articleno=${article.articleNo}";
      });
    
      document.querySelector("#btn-delete").addEventListener("click", function () {
        alert("글삭제하자!!!");
        location.href = "${root}/informarticle?action=delete&articleno=${article.articleNo}";
      });
    </script>
