...
<html>
  ...
  <body>
    ...
    <div class="sb-nav-fixed">
      <div class="mt-5 pt-5">
        <div class="container px-4">
          <h1 class="mt-4 d-flex justify-content-center">여행 경로 추천해요!</h1>
          ...
          <div class="container rounded bg-secondary bg-opacity-25 text-secondary fs-2 p-4 mb-2">
            ...
            <c:forEach var="attr" items="${route.attractions}">
				  <div class="col">
				    <div class="card m-2" style="width: 18rem;">
				      <img src="${attr.firstImage}" class="card-img-top" />
				      <div class="card-body">
				        <h5 class="card-title">${attr.title}</h5>
				        <p class="card-text">${attr.addr1}</p>
				      </div>
				    </div>
				  </div>
            </c:forEach>
    ...
    <script
      ...
      src="//dapi.kakao.com/v2/maps/sdk.js?appkey=e4cbdf27c43a803ff3c0f8fa1a9ec113&libraries=services,clusterer,drawing"></script>
      <%-- <script type="text/javascript" src="<%= root %>/res/js/viewroutefunctions.js"></script> --%>
